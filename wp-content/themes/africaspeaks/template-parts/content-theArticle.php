                        ...
                        <div class="col-12">
                            ...
                            <form action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4">                                      
                                      <input type="text" class="form-control" id="validationCustom02" placeholder="Enter your email ......" required>                                      
                                    </div>
                                    <div class="col-md-3 mb-3 p-0 m-0">                                      
                                      <div class="input-group">
                                       
                                        <input type="submit" class="form-control text-white font-weight-bold" id="validationCustomUsername" value="Subscribe Now" aria-describedby="inputGroupPrepend" required style="background-color: #ffc107;">
