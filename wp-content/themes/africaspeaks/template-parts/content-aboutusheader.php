...
<div class="container-fluid  header-div h-75" style="background-image: url('<?php echo $featuredimageurl?>');">
      ...
      <div class="col-md-4">
        ...
        <nav class="navbar navbar-expand-sm ">
            <div class="container-fluid">
                ...
                <div class="navbar-collapse navbarNavcollapsed  collapse " id="main-menu">
                <?php
                  wp_nav_menu(array(
