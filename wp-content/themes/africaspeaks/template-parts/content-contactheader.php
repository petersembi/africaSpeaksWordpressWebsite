...
<!-- <div class="container-fluid  header-div header-div-contact_us" style="background-image: url('<?php //bloginfo( 'stylesheet_directory' )?>/assets/images/contact_us_1_darkened.png');"> -->
<div class="container-fluid  header-div header-div-contact_us" style="background-image: url('<?php echo $featuredimageurl?>');">
